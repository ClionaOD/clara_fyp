...
applywarp -i ${ROIPTH}/schaefer_40weeks_VVC.nii.gz -o ${DWIPTH}/${SUBJ}/${SES}/probtrackx2_clara/${SUBJ}_${SES}_A424_target_regions_dwi.nii.gz -r ${DWIPTH}/${SUBJ}/${SES}/dwi/${SUBJ}_${SES}_desc-preproc_space-dwi_brainmask.nii.gz -w ${DWIPTH}/${SUBJ}/${SES}/xfm/${SUBJ}_${SES}_from-template40wk_to-dwi_mode-image.nii.gz --interp=nn
...
TOSPLIT=${DWIPTH}/${SUBJ}/${SES}/probtrackx2_clara/${SUBJ}_${SES}_A424_target_regions_dwi.nii.gz
...
COUNTS=`fslstats $TOSPLIT -H 396 0 396` # COUNT VOXELS IN EACH REGION
IND=0
for X in $COUNTS
do
